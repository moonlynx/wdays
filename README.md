...
2. [Базовые данные] (#Базовые-данные)
    1. [Основной конфигурационный файл] (#Основной-конфигурационный-файл)
    2. [Изменение таблиц обследований] (#Изменение-таблиц-обследований)
...
При формировании таблицы каждый объект обследования становится ее строкой. Поэтому:
